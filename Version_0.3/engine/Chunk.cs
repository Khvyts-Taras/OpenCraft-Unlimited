...
namespace OpenCraft
{
    public class Chunk
    {
        ...
        public byte[,,] Blocks;
        public ConcurrentDictionary<(int,int,int), Chunk>? Chunks;
        ...
        public Chunk(int x, int y, int z, SimpleGridAtlas atlas)
        {
            Atlas = atlas;
        ...
        public void AttachWorld(ConcurrentDictionary<(int,int,int), Chunk> chunks)
        {
            Chunks = chunks;
        }     
        ...
        static bool IsSolid(byte b) {return !(b == 0 || b == 9);}
