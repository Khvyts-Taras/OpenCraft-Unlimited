...
namespace OpenCraft
{
    public class World : IDisposable
    {
        ...
        public ConcurrentDictionary<(int, int, int), Chunk> Chunks = new();
        ...
        {  
            ...
            Atlas.Add("textures/glass.png",       id: 9);
        ...
        {
            WorldShader.Dispose();
            foreach (Chunk chunk in Chunks.Values) {if (chunk.mesh != null) chunk.mesh.Dispose();}
        }
        ...
        public void Draw(Camera camera, float timeOfDay)
        {
            ...
            WorldShader.SetFloat("timeOfDay", timeOfDay);
